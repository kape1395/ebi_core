...
start(normal, _Args) ->
    %MifCl2Name = mifcl2,
    %MifCl2Cfg = {ebi_queue_mifcl2, MifCl2Name, [
    %    {partition,
    %        long,                   % name
    %        "uosis.mif.vu.lt",      % host
    %        22,                     % port
    %        "karolis",              % user
    %        "/home/karolis/CODE/kape1395.biosensor.solver-2D/src/ebi/etc/ssh", % local user dir
